  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M14 10H12V8C12 7.45 11.55 7 11 7C10.45 7 10 7.45 10 8V10H8C7.45 10 7 10.45 7 11C7 11.55 7.45 12 8 12H10V14C10 14.55 10.45 15 11 15C11.55 15 12 14.55 12 14V12H14C14.55 12 15 11.55 15 11C15 10.45 14.55 10 14 10Z"
        fill={fill}
      />
    </Svg>
  );
