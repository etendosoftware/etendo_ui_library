...
export const CloudRainIcon = ({
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
      <G clip-path="url(#clip0_1992_7641)">
        <Path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M16 12C16.5523 12 17 12.4477 17 13V21C17 21.5523 16.5523 22 16 22C15.4477 22 15 21.5523 15 21V13C15 12.4477 15.4477 12 16 12Z"
          fill={fill}
        />
        <Path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M8.00003 12C8.55232 12 9.00003 12.4477 9.00003 13V21C9.00003 21.5523 8.55232 22 8.00003 22C7.44775 22 7.00003 21.5523 7.00003 21V13C7.00003 12.4477 7.44775 12 8.00003 12Z"
          fill={fill}
        />
        <Path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M12 14C12.5523 14 13 14.4477 13 15V23C13 23.5523 12.5523 24 12 24C11.4477 24 11 23.5523 11 23V15C11 14.4477 11.4477 14 12 14Z"
          fill={fill}
        />
        <Path
          fill-rule="evenodd"
