  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M12 11C10.3431 11 9 12.3431 9 14C9 15.6569 10.3431 17 12 17C13.6569 17 15 15.6569 15 14C15 12.3431 13.6569 11 12 11ZM7 14C7 11.2386 9.23858 9 12 9C14.7614 9 17 11.2386 17 14C17 16.7614 14.7614 19 12 19C9.23858 19 7 16.7614 7 14Z"
        fill={fill}
      />
      <Path
        fill-rule="evenodd"
