    ...
    return (
        <View style={styles.wrapper} ref={dropdownRef}>
            <InputBase
                ...
                rightButtons={[
                    <TouchableOpacity disabled={isDisabled} key="dropdownToggle" style={[dropdownVisible && styles.iconOpen,{paddingHorizontal:0}]} onPress={(event) => { event.stopPropagation(); toggleDropdown(); }}>
