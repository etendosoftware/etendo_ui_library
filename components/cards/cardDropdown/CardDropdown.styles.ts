...
export const CardVariant: CardStyleVariant = {
  primary: {
    colorCardContainer: {backgroundColor: NEUTRALS_100},
    colorCardImageContainer: {backgroundColor: QUATERNARY_50},
    colorCardTitle: {color: PRIMARY_100},
    colorCardOptionContainer: {backgroundColor: NEUTRALS_100},
    colorCardOptionHeader: {
      backgroundColor: PRIMARY_100,
      borderBottomColor: NEUTRALS_100,
    },
    colorCardOptionHeaderTitle: {color: NEUTRALS_100},
  ...
  secondary: {
    ...
    colorCardTitle: {color: NEUTRALS_100},
    ...
    colorCardOptionHeaderTitle: {color: NEUTRALS_100},
    colorCardItemContainer: {borderBottomColor: NEUTRALS_0},
    colorCardItemTitle: {color: NEUTRALS_100},
    ...
    colorCardOptionSkeletonHeaderItem: PRIMARY_80,
    colorCardArrowImageFill: NEUTRALS_100,
    colorCardImageFill: SECONDARY_100,
    colorCardImageOptionFill: NEUTRALS_100,
  },
  disabledPrimary: {
