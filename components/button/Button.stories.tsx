...
primary.args =
{
    ...
    typeStyle:'primary',
    image: {imgRoute:require('../asset/CheckWhite.png'),imgHeight:10, imgWidth: 12, imgMarginRight: 10},
    disabled:false,
    typeSize:'large'
...
secondary.args =
{
    ...
    onPress:()=> {console.log('Press Button')},
    typeStyle:'secondary',
    image: {imgRoute:require('../asset/Check.png'),imgHeight:10, imgWidth: 12, imgMarginRight: 10},
    disabled:false,
    typeSize:'large'
}
